let
  ...
  semreh_user = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMCzv/x3Mly7m621sMV+jtlyFRtazkfA6B6m8yMIV1Yv";
  semreh_host = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMCzv/x3Mly7m621sMV+jtlyFRtazkfA6B6m8yMIV1Yv";

  arete = [arete_user arete_host];
  cratos = [cratos_user cratos_host];
  semreh = [semreh_user semreh_host];
in {
  "tailscale.age".publicKeys = arete ++ cratos ++ semreh;
}
